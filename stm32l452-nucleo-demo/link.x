...
SECTIONS
{
  ...
  .text _stext :
  {
    __stext = .;
        ...
        *(privileged_functions)
        ...
        . = ALIGN(__privileged_functions_region_size__);;
  ...
  /* ## Sections in RAM */
    ...
    {
        . = ALIGN(4);
        __sdata = .;    /* Create a global symbol at data start. */
        *(privileged_data)
        . = ALIGN(4);
        FILL(0xDEAD);
        ...
        . = ALIGN(__privileged_data_region_size__);
    } >RAM AT> FLASH
  ...
  /* LMA of .data */
  __sidata = LOADADDR(.privileged_data);
